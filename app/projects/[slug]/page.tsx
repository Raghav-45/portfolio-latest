...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: [project.title, ...project.tech, siteConfig.personal.fullName, siteConfig.personal.role, "Case Study", "Portfolio"],
    openGraph: {
      type: "article",
      url,
      title: project.title,
      ...
      tags: [project.title, ...project.tech],
    },
    twitter: {
...
export default async function ProjectPage({
  ...
  const creativeWorkSchema = {
    ...
    "@id": `${url}#creativework`,
    name: project.title,
    description: project.caseStudy?.problem ? `${project.description} ${project.caseStudy.problem}` : project.description,
    url,
    sameAs: project.link,
    keywords: [project.title, ...project.tech, "Software Development"].join(", "),
