    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ scale: 0.94, opacity: 0, y: 8, transition: { duration: 0.12 } }}
          transition={{ type: "spring", damping: 32, stiffness: 420 }}
          onPointerDown={onFocus}
        >
          {/* Drag wrapper — only this div is draggable, isolated from content clicks */}
          <motion.div
            drag
            ...
            dragMomentum={false}
            dragElastic={0}
            style={{ x: savedOffset.current.x, y: savedOffset.current.y }}
            onDragEnd={(_, info) => {
              if (!posKey) return
              ...
              >
                ...
                <div className="flex items-center gap-[7px] z-10">
                  ...
                  <button
                    ...
                    style={{
                      background: !isFocused ? "#4E4F52" : activeBtn === "close" ? "#F09389" : "#EC6A5E",
                  ...
                  <span
                    ...
                    style={{
                      background: !isFocused ? "#4E4F52" : activeBtn === "minimize" ? "#FBEB74" : "#F4BF4F",
                      transition: "background 0.1s",
                    }}
                  ...
                  <span
                    ...
                    className="w-3 h-3 rounded-full flex items-center justify-center"
                    style={{
                      background: !isFocused ? "#4E4F52" : activeBtn === "maximize" ? "#86F37E" : "#62C554",
                      transition: "background 0.1s",
                    }}
